...
def login():
    ...
    driver.find_element_by_id('u').send_keys('')# 填你的qq号
    driver.find_element_by_id('p').clear()
    driver.find_element_by_id('p').send_keys('')# 填你的密码
...
def in_mysql(time,content,conn):
    time=str(time)
    content=str(content)
    sql="insert into qqhome(time,data) VALUES('"+time+"','"+content+"')"
    conn.query(sql)
    conn.commit()
...
def get_allQQ(mysession,g_tk,qzonetoken): 
    #获取好友QQ的网址
    #测试地址https://user.qzone.qq.com/proxy/domain/r.qzone.qq.com/cgi-bin/tfriend/friend_ship_manager.cgi?uin=1576946238&do=1&rd=0.7020990069082498&fupdate=1&clean=1&g_tk=690512869&qzonetoken=700a9d01853122f35f3606eaaa982bcbba6292c3a4fb5997eb384b0d6268e618629f0eb19114332119f5&g_tk=690512869
    url_friend='https://user.qzone.qq.com/proxy/domain/r.qzone.qq.com/cgi-bin/tfriend/friend_ship_manager.cgi?uin=1576946238&do=1&rd=0.7020990069082498&fupdate=1&clean=1&g_tk='+str(g_tk)+'&qzonetoken='+qzonetoken+'&g_tk='+str(g_tk)
    #url_friend=https://user.qzone.qq.com/1576946238/myhome/friends/index?uin=o1576946238&do=1&fupdate=1&clean=1&g_tk='+str(g_tk)+'&qzonetoken='+qzonetoken
    #url_friend='https://user.qzone.qq.com/proxy/domain/r.qzone.qq.com/cgi-bin/tfriend/friend_ship_manager.cgi?uin=1576946238&do=1&fupdate=1&clean=1&g_tk='+str(g_tk)+'&qzonetoken='+qzonetoken
    friendpat='"uin":(.*?),'
